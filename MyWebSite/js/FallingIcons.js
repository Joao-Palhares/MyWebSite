...
function createFallingIcon() {
    ...
    icon.src = "MyWebSite/images/Gaming.png"; // Ensure correct path
...
function destroyIcon(icon, posY, posX) {
    ...
    explosion.src = "MyWebSite/images/explosion.gif"; // Add your explosion GIF in /wwwroot/imgs/
    ...
    const bombsound = new Audio("MyWebSite/sounds/explosion.mp3");
